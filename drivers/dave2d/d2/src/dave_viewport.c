		   ...
		   d2_border ymax)
{
	...
	D2_CHECKERR(xmax >= xmin, D2_INVALIDWIDTH);
		/* PRQA S 4130, 3112, 3453 */ /* $Misra: #DEBUG_MACRO $*/
	D2_CHECKERR(ymax >= ymin, D2_INVALIDHEIGHT);
		/* PRQA S 4130, 3112, 3453 */ /* $Misra: #DEBUG_MACRO $*/
	...
	/* store boundary */
	D2_DEV(handle)->clipxmin = (d2_point)D2_FIX4(xmin);
		/* PRQA S 4131 */ /* $Misra: #PERF_ARITHMETIC_SHIFT_LEFT $*/
	D2_DEV(handle)->clipymin = (d2_point)D2_FIX4(ymin);
		/* PRQA S 4131 */ /* $Misra: #PERF_ARITHMETIC_SHIFT_LEFT $*/
	D2_DEV(handle)->clipxmax = (d2_point)D2_FIX4(xmax);
		/* PRQA S 4131 */ /* $Misra: #PERF_ARITHMETIC_SHIFT_LEFT $*/
	D2_DEV(handle)->clipymax = (d2_point)D2_FIX4(ymax);
		/* PRQA S 4131 */ /* $Misra: #PERF_ARITHMETIC_SHIFT_LEFT $*/
		      ...
		      d2_s32 format)
{
	...
	D2_CHECKERR(width > 1, D2_VALUETOOSMALL);
		/* PRQA S 4130, 3112, 3453 */ /* $Misra: #DEBUG_MACRO $*/
	D2_CHECKERR(height > 1, D2_VALUETOOSMALL);
		/* PRQA S 4130, 3112, 3453 */ /* $Misra: #DEBUG_MACRO $*/
	...
	case d2_mode_rgba4444:
		D2_DEV(handle)->fbstylemask =
			D2C_WRITEFORMAT3 | D2C_WRITEFORMAT2 | D2C_WRITEFORMAT1;
		D2_DEV(handle)->bpp = 2;
		break;

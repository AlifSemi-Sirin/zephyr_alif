				   ...
				   d2_point x4, d2_point y4, d2_u32 flags)
{
	...
	d2_u32 dxm = ((dx1 < 0) ? 1u : 0u) | ((dx2 < 0) ? 2u : 0u) | ((dx3 < 0) ? 4u : 0u) |
		     ((dx4 < 0) ? 8u : 0u);
	d2_u32 dym = ((dy1 < 0) ? 1u : 0u) | ((dy2 < 0) ? 2u : 0u) | ((dy3 < 0) ? 4u : 0u) |
		     ((dy4 < 0) ? 8u : 0u);
	d2_u32 idxm = dxm ^ 15u;
	d2_u32 idym = dym ^ 15u;
...
d2_s32 d2_renderquad_solid(d2_device *handle, d2_point x1, d2_point y1, d2_point x2, d2_point y2,
			   d2_point x3, d2_point y3, d2_point x4, d2_point y4, d2_u32 flags)
{
	(void)d2_renderquad_intern(D2_DEV(handle), D2_DEV(handle)->ctxsolid, x1, y1, x2, y2, x3, y3,
				   x4, y4, flags);
			    ...
			    d2_point x3, d2_point y3, d2_point x4, d2_point y4, d2_u32 flags)
{
	...
	/* render shadow */
	(void)d2_renderquad_intern(D2_DEV(handle), D2_DEV(handle)->ctxoutline, (d2_point)(x1 + sx),
				   (d2_point)(y1 + sy), (d2_point)(x2 + sx), (d2_point)(y2 + sy),
				   (d2_point)(x3 + sx), (d2_point)(y3 + sy), (d2_point)(x4 + sx),
				   (d2_point)(y4 + sy), flags);

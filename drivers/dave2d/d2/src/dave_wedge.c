...
static d2_s32 d2_renderwedge_intern(d2_devicedata *handle, d2_contextdata *ctx, d2_point x,
				    ...
				    d2_s32 nx2, d2_s32 ny2, d2_u32 flags); /* MISRA */
...
static d2_s32 is_same_direction(d2_s32 nx1, d2_s32 ny1, d2_s32 nx2, d2_s32 ny2)
{
	...
	/* check 180 deg */
	if (((nx1 >= 0) && (nx2 >= 0)) || ((nx1 < 0) && (nx2 < 0)) || ((ny1 >= 0) && (ny2 >= 0)) ||
	    ((ny1 < 0) && (ny2 < 0))) {
		return 0;
	}
	...
	leading_zeroes =
		count_leading_zeroes16((nx1 > 0) ? (d2_u16)(nx1 >> 16) : (d2_u16)((-nx1) >> 16));
		/* PRQA S 0502 */ /* $Misra: #PERF_ARITHMETIC_SHIFT_RIGHT $*/
		/* PRQA S 3759 */ /* $Misra: #MISRA_BUG_IMPLICIT_CONVERSION_S32_TO_U16 $*/
	...
	leading_zeroes =
		count_leading_zeroes16((ny1 > 0) ? (d2_u16)(ny1 >> 16) : (d2_u16)((-ny1) >> 16));
		/* PRQA S 0502 */ /* $Misra: #PERF_ARITHMETIC_SHIFT_RIGHT $*/
		/* PRQA S 3759 */ /* $Misra: #MISRA_BUG_IMPLICIT_CONVERSION_S32_TO_U16 $*/
	nx1 >>= 16u - leading_zeroes; /* PRQA S 0502 */ /* $Misra: #PERF_ARITHMETIC_SHIFT_RIGHT $*/
	ny1 >>= 16u - leading_zeroes; /* PRQA S 0502 */ /* $Misra: #PERF_ARITHMETIC_SHIFT_RIGHT $*/
	...
	leading_zeroes =
		count_leading_zeroes16((nx2 > 0) ? (d2_u16)(nx2 >> 16) : (d2_u16)((-nx2) >> 16));
		/* PRQA S 0502 */ /* $Misra: #PERF_ARITHMETIC_SHIFT_RIGHT $*/
		/* PRQA S 3759 */ /* $Misra: #MISRA_BUG_IMPLICIT_CONVERSION_S32_TO_U16 $*/
	...
	leading_zeroes =
		count_leading_zeroes16((ny2 > 0) ? (d2_u16)(ny2 >> 16) : (d2_u16)((-ny2) >> 16));
		/* PRQA S 0502 */ /* $Misra: #PERF_ARITHMETIC_SHIFT_RIGHT $*/
		/* PRQA S 3759 */ /* $Misra: #MISRA_BUG_IMPLICIT_CONVERSION_S32_TO_U16 $*/
	nx2 >>= 16u - leading_zeroes; /* PRQA S 0502 */ /* $Misra: #PERF_ARITHMETIC_SHIFT_RIGHT $*/
	ny2 >>= 16u - leading_zeroes; /* PRQA S 0502 */ /* $Misra: #PERF_ARITHMETIC_SHIFT_RIGHT $*/

	/* if scalar product of v1 * (v2+90 deg) is zero then both vectors have same direction */

	nx1 >>= 1;
	ny1 >>= 1;
	nx2 >>= 1;
	ny2 >>= 1; /* PRQA S 0502 */ /* $Misra: #PERF_ARITHMETIC_SHIFT_RIGHT $*/
...
{
	(void)d2_renderwedge_intern(D2_DEV(handle), D2_DEV(handle)->ctxsolid, x, y, r, w, nx1, ny1,
				    nx2, ny2, flags);
...
d2_s32 d2_renderwedge_outline(d2_device *handle, d2_point x, d2_point y, d2_width r, d2_width w,
			      d2_s32 nx1, d2_s32 ny1, d2_s32 nx2, d2_s32 ny2, d2_u32 flags)
{
	(void)d2_renderwedge_intern(D2_DEV(handle), D2_DEV(handle)->ctxoutline, x, y, r,
				    (d2_width)(w + (D2_DEV(handle)->outlinewidth * 2)), nx1, ny1,
				    nx2, ny2, flags);
			     ...
			     d2_s32 nx1, d2_s32 ny1, d2_s32 nx2, d2_s32 ny2, d2_u32 flags)
{
	...
	(void)d2_renderwedge_intern(D2_DEV(handle), D2_DEV(handle)->ctxoutline, (d2_point)(x + sx),
				    (d2_point)(y + sy), r, w, nx1, ny1, nx2, ny2, flags);
